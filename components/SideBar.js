                ...
                <div className="sidebar-scroll">
                    <>
                        <ul className="nav">
                            ...
                            <li><Link href="/manage/auction"><a className={classNames({ "active": activeLink('/manage/auction') })}><i className="lnr lnr-layers" aria-hidden></i> <span>Quản lí đấu giá</span></a></Link></li>
                            ...
                            <li><Link href="/manage/notification"><a className={classNames({ "active": activeLink('/manage/notification') })}><i className="lnr lnr-alarm" aria-hidden></i> <span>Quản lí thông báo</span></a></Link></li>
